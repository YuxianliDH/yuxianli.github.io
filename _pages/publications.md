...
for Memory Error Detection", in *IEEE Transactions on Software Engineering*. [[PDF]](https://haoxintu.github.io/files/SymLoc_TSE2024_Just_Accepted.pdf) [[Source Code]](https://github.com/haoxintu/SymLoc)
 ...
 * [2023] **Haoxin Tu**, Zhide Zhou, He Jiang, Imam Nur Bani Yusuf, Yuxian Li, and Lingxiao Jiang, "LLM4CBI: Taming LLMs to Generate Effective Test Programs for Compiler Bug Isolation", Minor Revision in *IEEE Transactions on Software Engineering*. [[arXiv]](https://arxiv.org/pdf/2307.00593.pdf) [[Source Code]](https://github.com/haoxintu/LLM4CBI)
